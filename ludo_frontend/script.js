...
const playerNameCoordinatesPercent = {
    red:    { top: '95.5%', left: '80%', textAlign: 'center' },  // Pastki o'ng burchak
    green:  { top: '95.5%', left: '20%', textAlign: 'center' },   // Pastki chap burchak
    yellow: { top: '0.45%', left: '20%', textAlign: 'center' },    // Yuqori chap burchak
    blue:   { top: '0.45%', left: '80%', textAlign: 'center' }    // Yuqori o'ng burchak
};
